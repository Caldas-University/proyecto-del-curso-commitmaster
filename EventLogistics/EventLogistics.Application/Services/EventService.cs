...
namespace EventLogistics.Application.Services
{
    public class EventService : IEventService
    {
        ...
        {
            var newEvent = new Event(newEventDto.Name, newEventDto.Place, newEventDto.Schedule, newEventDto.Status);
            ...
            return new EventDto
            {
                ...
                Resources = createdEvent.Resources,
        ...
        }        public async Task<List<EventDto>> GetEventsByPlaceAsync(string place)
        {
            var events = await _eventRepository.GetAllAsync();
